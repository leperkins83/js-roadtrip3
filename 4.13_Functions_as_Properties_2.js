...
// create addBulb function property here, value of addBulb will be a function
//the word this is the same as typing out lighthousePointe which is the parent object you are referring to
lighthousePointe.addBulb = function(name, wattage){
  this.weaponBulbs.push([name, wattage]); // this will push a sub-array into the array weaponBulbs
};

lighthousePointe.addBulb('photon-3000', 3000);
